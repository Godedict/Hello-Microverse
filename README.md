...
Fork this repoository to your desired folder
...
## About the Project
Ths project is part of my exercise in the training
...
## Contributing
- The project is open for contributions, issues, and feature request are allowed!
- You can open an issue via [issues page] (https://github.com/Godedict)


 ## Show your support
- Give a start rating if you like the project!


## Acknowledgements
- A big thanks to anyone whose idea, inspiration was applied.


##License
This project is [MIT](./MIT.md) licensed
st Microverse project
...
A working laptop and a stable internet
